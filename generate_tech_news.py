...
def generate_news():
    ...
    4. Статията трябва да е дълва, съдържаща няколко последователни смислови блока, които текат един след друг естествено.
    ...
    create_static_pages()
    print("🎉 Успешно създадена и записана статия без подзаглавия!")
